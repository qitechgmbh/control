...
pub fn init_mock(app_state: Arc<SharedState>) -> Result<(), anyhow::Error> {
    ...
    return smol::block_on(async {
        ...
        use machines::{SerialDeviceNew, SerialDeviceNewParams, serial::devices::{extruder_mock::ExtruderMockSerialDevice, mock::MockSerialDevice, winder_mock::WinderMockSerialDevice}};
