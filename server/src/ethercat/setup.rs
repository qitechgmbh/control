...
use ethercat_hal::devices::wago_750_354::{WAGO_750_354_PRODUCT_ID, WAGO_750_354_VENDOR_ID, Wago750_354};
...
use ethercrab::{MainDevice, MainDeviceConfig, PduStorage, RetryBehaviour, SubDeviceIdentity, Timeouts};
