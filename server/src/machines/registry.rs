use crate::machines::{
    buffer1::BufferV1, extruder1::ExtruderV2, laser::LaserMachine, mock::MockMachine, mock2::Mock2Machine, winder2::Winder2, MACHINE_EXTRUDER_V1, MACHINE_LASER_V1, VENDOR_QITECH
};
