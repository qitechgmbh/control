...
use ethercat_hal::devices::el7031_0030::{
    self, EL7031_0030StepperPort, EL7031_0030, EL7031_0030_IDENTITY_A
};
    ...
    fn new<'maindevice>(params: &MachineNewParams) -> Result<Self, Error> {
        ...
        smol::block_on(async {
           ...
           // Role 2
            ...
            let buffer_speed_controller = BufferSpeedController::new(
                Velocity::new::<meter_per_minute>(1.0),
                Length::new::<millimeter>(1.75),
                LinearStepConverter::from_diameter(
                    200,
            ...
            let mut buffer: BufferV1 = Self {
                ...
                buffer_mode: BufferMode::Standby,
                t_0: t_0,
                frequency: frequency,
                connected_winder: None,
                puller_speed_controller,
                buffer_speed_controller,
