...
use control_core::actors::stepper_driver_el7031::StepperDriverEl7031;
...
use ethercat_hal::devices::el7031::coe::{EL7031Configuration, EL7031OperationMode, StmFeatures};
use ethercat_hal::devices::el7031::{EL7031Port, EL7031, EL7031_IDENTITY_A};
...
use ethercat_hal::io::stepper_velocity_el7031::StepperVelocityEL7031;
    ...
    fn new<'maindevice>(
        ...
        block_on(async {
            ...
            let el7031 = match subdevice_identity_to_tuple(&subdevice_identity) {
                EL7031_IDENTITY_A => downcast_device::<EL7031>(device.clone()).await?,
                _ => {
                    return Err(anyhow::anyhow!(
                        "[{}::MachineNewTrait/WinderV1::new] Device with role 3 is not an EL7041",
                        module_path!()
                    ))
                }
            };
            let el7031_config = EL7031Configuration {
                stm_features: StmFeatures {
                    operation_mode: EL7031OperationMode::DirectVelocity,
            ...
            // EL7031
            let mut new = Self {
                winder: StepperDriverEl7031::new(
                    StepperVelocityEL7031::new(el7031, EL7031Port::STM1),
