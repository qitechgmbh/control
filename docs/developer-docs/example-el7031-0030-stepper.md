...
![Wiring procedure](../assets/wiring.png)
...
![UI start motor](../assets/UI_start_motor.png)
...
Under "Maschine" select your new Machine however you named it (I named it TestMotor V1", else it will detect that there is something connected to it
but the connection won't work.

![Machine assignment motor](../assets/machine_assigment_motor.png)
