...
# Another Example: Beckhoff EL7031 0030 Stepper Motor Integration
...
<img src="./docs/assets/EL7031_0030.jpg" width="300">

Slide the EL7031 0030 onto the right side of the EK1100 until it locks.
The EtherCAT E-Bus and power contacts connect automatically — no wiring required.
---
### Figure 3 Motor
<img src="./docs/assets/motor.jpg" width="300">
---
### Figure 4 Motor wiring
<img src="./docs/assets/motor_wiring.jpg" width="300">

* Now the motor is wirited via the pins 4, 5, 12, 13 on the EL7031 0030.
---

### Figure 5 EL7031 Integration Connected

<img src="./docs/assets/EL7031_0030_connected.jpg" width="400">
...
Also, see the documentation of the ethercat (<a href="https://download.beckhoff.com/download/document/io/ethercat-terminals/el7031-0030de.pdf">EL7031</a>) 
for the different power modes (page 46 ff.)
...
## 4.3 Running the Frontend
```bash
# move to the ccontrol directory
cd electron
npm run start
```
This launches the QiTech Control dashboard.
...
![](./docs/assets/UI_start_motor.png)
...
Under "Maschine" select your new Machine however you named it (I named it TestMotor V1", else it will detect that there is something conneted to it
but the connection won't work.

![](./docs/assets/machine_assigment_motor.png)
...
![](./docs/assets/UI_motor.png)
---
## 6. Doc
Use the official documentation of the EL7031-0030 for more information.
<a href="https://download.beckhoff.com/download/document/io/ethercat-terminals/el7031-0030de.pdf">EL7031</a>
---

## 7. Software Architecture
### Backend (Rust)
Located in `machines/src/ethercat_beckhoff/`.
...
Located in `electron/src/machines/ethercat_beckhoff/` and `electron/src/routes/routes.tsx`
