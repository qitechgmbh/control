...
impl PredefinedPdoAssignment<EL7037TxPdo, EL7037RxPdo> for EL7037PredefinedPdoAssignment {
    fn txpdo_assignment(&self) -> EL7037TxPdo {
        match self {
            Self::VelocityControlCompact => EL7037TxPdo {
    ...
    fn rxpdo_assignment(&self) -> EL7037RxPdo {
        match self {
            ...
            Self::VelocityControl => EL7037RxPdo {
            ...
            Self::PositionControl => EL7037RxPdo {
                enc_control_compact: None,
                enc_control: Some(EncControl::default()),
                stm_control: Some(StmControl::default()),
            ...
            Self::PositionInterfaceCompact => EL7037RxPdo {
                enc_control_compact: None,
                enc_control: Some(EncControl::default()),
                stm_control: Some(StmControl::default()),
                stm_position: None,
            ...
            Self::PositionInterface | Self::PositionInterfaceWithInfoData => EL7037RxPdo {
                enc_control_compact: None,
                enc_control: Some(EncControl::default()),
                stm_control: Some(StmControl::default()),
                stm_position: None,
...
mod tests {
    ...
    fn test_pdo_assignment_velocity_control_compact() {
        let pdo_assignment = EL7037PredefinedPdoAssignment::VelocityControlCompact;
    ...
    fn test_pdo_assignment_velocity_control_compact_with_info_data() {
        let pdo_assignment = EL7037PredefinedPdoAssignment::VelocityControlCompactWithInfoData;
        let txpdo = pdo_assignment.txpdo_assignment();
        let rxpdo = pdo_assignment.rxpdo_assignment();
    ...
    fn test_pdo_assignment_velocity_control() {
        let pdo_assignment = EL7037PredefinedPdoAssignment::VelocityControl;
        let txpdo = pdo_assignment.txpdo_assignment();
        let rxpdo = pdo_assignment.rxpdo_assignment();
    ...
    fn test_pdo_assignment_position_control() {
        let pdo_assignment = EL7037PredefinedPdoAssignment::PositionControl;
        let txpdo = pdo_assignment.txpdo_assignment();
        let rxpdo = pdo_assignment.rxpdo_assignment();
    ...
    fn test_pdo_assignment_position_interface_compact() {
        let pdo_assignment = EL7037PredefinedPdoAssignment::PositionInterfaceCompact;
        let txpdo = pdo_assignment.txpdo_assignment();
        let rxpdo = pdo_assignment.rxpdo_assignment();
    ...
    fn test_pdo_assignment_position_interface() {
        let pdo_assignment = EL7037PredefinedPdoAssignment::PositionInterface;
        let txpdo = pdo_assignment.txpdo_assignment();
        let rxpdo = pdo_assignment.rxpdo_assignment();
    ...
    fn test_pdo_assignment_position_interface_with_info_data() {
        let pdo_assignment = EL7037PredefinedPdoAssignment::PositionInterfaceWithInfoData;
        let txpdo = pdo_assignment.txpdo_assignment();
        let rxpdo = pdo_assignment.rxpdo_assignment();
    ...
    fn test_pdo_assignment_position_interface_auto_start() {
        let pdo_assignment = EL7037PredefinedPdoAssignment::PositionInterfaceAutoStart;
        let txpdo = pdo_assignment.txpdo_assignment();
        let rxpdo = pdo_assignment.rxpdo_assignment();
    ...
    fn test_pdo_assignment_position_interface_auto_start_with_info_data() {
        let pdo_assignment = EL7037PredefinedPdoAssignment::PositionInterfaceAutoStartWithInfoData;
        let txpdo = pdo_assignment.txpdo_assignment();
        let rxpdo = pdo_assignment.rxpdo_assignment();
