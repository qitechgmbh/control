use crate::devices::{EthercatDeviceUsed,EthercatDevice, SubDeviceProductTuple};
...
pub const WAGO_750_501_MODULE_IDENT :SubDeviceProductTuple  = (WAGO_750_501_VENDOR_ID,WAGO_750_501_PRODUCT_ID);