use crate::devices::{EthercatDevice, EthercatDeviceUsed, SubDeviceProductTuple};
...
pub const WAGO_750_652_MODULE_IDENT :SubDeviceProductTuple  = (WAGO_750_652_VENDOR_ID,WAGO_750_652_PRODUCT_ID);