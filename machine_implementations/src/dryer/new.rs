...
use super::api::DryerMachineNamespace;
use super::core::DryerCore;
use super::device::DryerDevice;
use crate::{MachineHardware, MachineNew};
use anyhow::Error;
use std::time::Instant;

impl MachineNew for DryerMachine {
    fn new(hw: MachineHardware) -> Result<Self, Error> {
        ...
        Ok(Self {
            ...
            namespace: DryerMachineNamespace { namespace: None },
            core: DryerCore {
                dryer,
