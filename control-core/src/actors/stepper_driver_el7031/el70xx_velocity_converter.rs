use ethercat_hal::devices::el7031::coe::EL7031SpeedRange;

#[derive(Debug)]
pub struct EL7031VelocityCalculator {
    max_steps_per_seconds: u16,
}

impl EL7031VelocityCalculator {
    pub fn new(speed_range: &EL7031SpeedRange) -> Self {
        let speed_range_value = match speed_range {
            EL7031SpeedRange::Steps1000 => 1000,
            EL7031SpeedRange::Steps2000 => 2000,
            EL7031SpeedRange::Steps4000 => 4000,
            EL7031SpeedRange::Steps8000 => 8000,
            EL7031SpeedRange::Steps16000 => 16000,
            EL7031SpeedRange::Steps32000 => 32000,
        };
        Self {
...
mod tests {
    ...
    fn test_steps_to_velocity_conversion() {
        let calc = EL7031VelocityCalculator::new(&EL7031SpeedRange::Steps4000); // 4000 steps/s
