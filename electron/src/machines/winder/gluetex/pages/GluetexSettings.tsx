                    ...
                    <div className="flex flex-row flex-wrap gap-4">
                      <Label label="Tension Target">
                        <EditValue
                          ...
                          renderValue={(value) => roundToDecimals(value, 2)}
                          onChange={(value) =>
                            setSpoolAdaptiveTensionTarget(value)
                          }
                        />
                      </Label>
                    ...
                    <div className="flex flex-row flex-wrap gap-4">
                      <Label label="Proportional Gain (Kp)">
                        <EditValue
                          ...
                          max={15}
                          defaultValue={
                            defaultState?.heating_pid_settings?.zone_1?.kp
                          }
                      ...
                      <Label label="Integral Gain (Ki)">
                        <EditValue
                          ...
                          max={15}
                          defaultValue={
                            defaultState?.heating_pid_settings?.zone_1?.ki
                          }
                      ...
                      <Label label="Derivative Gain (Kd)">
                        <EditValue
                          ...
                          max={15}
                          defaultValue={
                            defaultState?.heating_pid_settings?.zone_1?.kd
                          }
                          renderValue={(value) => roundToDecimals(value, 4)}
                          onChange={(value) =>
                            setHeatingPid(
                    ...
                    <div className="flex flex-row flex-wrap gap-4">
                      <Label label="Proportional Gain (Kp)">
                        <EditValue
                          ...
                          max={15}
                          defaultValue={
                            defaultState?.heating_pid_settings?.zone_2?.kp
                          }
                          renderValue={(value) => roundToDecimals(value, 3)}
                          onChange={(value) =>
                            setHeatingPid(
                      ...
                      <Label label="Integral Gain (Ki)">
                        <EditValue
                          ...
                          max={15}
                          defaultValue={
                            defaultState?.heating_pid_settings?.zone_2?.ki
                          }
                          renderValue={(value) => roundToDecimals(value, 4)}
                          onChange={(value) =>
                            setHeatingPid(
                      ...
                      <Label label="Derivative Gain (Kd)">
                        <EditValue
                          ...
                          max={15}
                          defaultValue={
                            defaultState?.heating_pid_settings?.zone_2?.kd
                          }
                          renderValue={(value) => roundToDecimals(value, 4)}
                          onChange={(value) =>
                            setHeatingPid(
                    ...
                    <div className="flex flex-row flex-wrap gap-4">
                      <Label label="Proportional Gain (Kp)">
                        <EditValue
                          ...
                          max={15}
                          defaultValue={
                            defaultState?.heating_pid_settings?.zone_3?.kp
                          }
                          renderValue={(value) => roundToDecimals(value, 3)}
                          onChange={(value) =>
                            setHeatingPid(
                      ...
                      <Label label="Integral Gain (Ki)">
                        <EditValue
                          ...
                          max={15}
                          defaultValue={
                            defaultState?.heating_pid_settings?.zone_3?.ki
                          }
                          renderValue={(value) => roundToDecimals(value, 4)}
                          onChange={(value) =>
                            setHeatingPid(
                      ...
                      <Label label="Derivative Gain (Kd)">
                        <EditValue
                          ...
                          max={15}
                          defaultValue={
                            defaultState?.heating_pid_settings?.zone_3?.kd
                          }
                          renderValue={(value) => roundToDecimals(value, 4)}
                          onChange={(value) =>
                            setHeatingPid(
                    ...
                    <div className="flex flex-row flex-wrap gap-4">
                      <Label label="Proportional Gain (Kp)">
                        <EditValue
                          ...
                          max={15}
                          defaultValue={
                            defaultState?.heating_pid_settings?.zone_4?.kp
                          }
                          renderValue={(value) => roundToDecimals(value, 3)}
                          onChange={(value) =>
                            setHeatingPid(
                      ...
                      <Label label="Integral Gain (Ki)">
                        <EditValue
                          ...
                          max={15}
                          defaultValue={
                            defaultState?.heating_pid_settings?.zone_4?.ki
                          }
                          renderValue={(value) => roundToDecimals(value, 4)}
                          onChange={(value) =>
                            setHeatingPid(
                      ...
                      <Label label="Derivative Gain (Kd)">
                        <EditValue
                          ...
                          max={15}
                          defaultValue={
                            defaultState?.heating_pid_settings?.zone_4?.kd
                          }
                          renderValue={(value) => roundToDecimals(value, 4)}
                          onChange={(value) =>
                            setHeatingPid(
                    ...
                    <div className="flex flex-row flex-wrap gap-4">
                      <Label label="Proportional Gain (Kp)">
                        <EditValue
                          ...
                          max={15}
                          defaultValue={
                            defaultState?.heating_pid_settings?.zone_5?.kp
                          }
                          renderValue={(value) => roundToDecimals(value, 3)}
                          onChange={(value) =>
                            setHeatingPid(
                      ...
                      <Label label="Integral Gain (Ki)">
                        <EditValue
                          ...
                          max={15}
                          defaultValue={
                            defaultState?.heating_pid_settings?.zone_5?.ki
                          }
                          renderValue={(value) => roundToDecimals(value, 4)}
                          onChange={(value) =>
                            setHeatingPid(
                      ...
                      <Label label="Derivative Gain (Kd)">
                        <EditValue
                          ...
                          max={15}
                          defaultValue={
                            defaultState?.heating_pid_settings?.zone_5?.kd
                          }
                          renderValue={(value) => roundToDecimals(value, 4)}
                          onChange={(value) =>
                            setHeatingPid(
                    ...
                    <div className="flex flex-row flex-wrap gap-4">
                      <Label label="Proportional Gain (Kp)">
                        <EditValue
                          ...
                          max={15}
                          defaultValue={
                            defaultState?.heating_pid_settings?.zone_6?.kp
                          }
                          renderValue={(value) => roundToDecimals(value, 3)}
                          onChange={(value) =>
                            setHeatingPid(
                      ...
                      <Label label="Integral Gain (Ki)">
                        <EditValue
                          ...
                          max={15}
                          defaultValue={
                            defaultState?.heating_pid_settings?.zone_6?.ki
                          }
                          renderValue={(value) => roundToDecimals(value, 4)}
                          onChange={(value) =>
                            setHeatingPid(
                      ...
                      <Label label="Derivative Gain (Kd)">
                        <EditValue
                          ...
                          max={15}
                          defaultValue={
                            defaultState?.heating_pid_settings?.zone_6?.kd
                          }
                          renderValue={(value) => roundToDecimals(value, 4)}
                          onChange={(value) =>
                            setHeatingPid(
