...
const extruder3DeviceRoles = [
  ...
  },
  {
    ...
    allowed_devices: [
      { vendor_id: 2, product_id: 394604626, revision: 1376256 },
      { vendor_id: 2, product_id: 394604626, revision: 0x140000 },
      { vendor_id: 2, product_id: 394604626, revision: 0x160000 },
      { vendor_id: 2, product_id: 394604626, revision: 0x100000 },
    ],
  },
  {
    role: 2,
    ...
    allowed_devices: [
      { vendor_id: 2, product_id: 131346514, revision: 1179648 },
    ],
  },
  {
    role: 3,
    ...
    allowed_devices: [
      { vendor_id: 2, product_id: 197996626, revision: 1310720 },
    ],
  },
  {
    role: 4,
    ...
    allowed_devices: [
      { vendor_id: 2, product_id: 0xc843052, revision: 1441792 },
      { vendor_id: 2, product_id: 0xc843052, revision: 0x150000 },
    ],
  },
];
...
export const extruder3: MachineProperties = {
  ...
  slug: "extruder3",
  icon: "qi:Extruder",
  machine_identification: { vendor: VENDOR_QITECH, machine: 0x0016 },
  device_roles: extruder3DeviceRoles,
};

export const extruder3reversed: MachineProperties = {
  ...extruder3,
  version: "V3 (Reversed Screw)",
  machine_identification: { vendor: VENDOR_QITECH, machine: 0x0017 },
};
