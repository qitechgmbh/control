...
export function Aquapath1GraphPage() {
  ...
  const front_flow_target = state?.flow_states.front.target_flow ?? 0;
  const back_flow_target = state?.flow_states.back.target_flow ?? 0;
