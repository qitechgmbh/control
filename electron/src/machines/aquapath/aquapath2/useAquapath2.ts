...
import { Mode, StateEvent, useAquapath2Namespace } from "./aquapath2Namespace";
...
export function useAquapath2() {
  ...
  const machineIdentification: MachineIdentificationUnique = useMemo(() => {
    ...
    return {
      machine_identification: aquapath2.machine_identification,
      serial,
    };
  }, [serialString]);
  ...
  } = useAquapath2Namespace(machineIdentification);
