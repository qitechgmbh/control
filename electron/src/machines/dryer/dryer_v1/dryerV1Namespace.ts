...
// `is_smart` and `smart_data` are always present - a non-Smart unit just reports
// `is_smart: false` with default/empty `smart_data`, since both hardware variants are
// driven by the same backend machine.
