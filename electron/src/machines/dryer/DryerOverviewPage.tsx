...
/// Shared by both the V1 and Smart dryer routes - the Smart-only "Firmware" card is
/// gated on `v.is_smart`, reported directly by the connected hardware.
