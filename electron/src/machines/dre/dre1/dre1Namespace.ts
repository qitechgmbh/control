 ...
 */
export const createDre1NamespaceStore =
    (): StoreApi<Dre1NamespaceStore> =>
        create<Dre1NamespaceStore>((set) => {
            return {
                dreState: null,
    ...
    return (event: Event<any>) => {
        ...
        try {
            ...
            // Metric events (keep for 1 hour)
                ...
                let parsed = diameterEventSchema.parse(event);
...
export function useDre1Namespace(
    ...
    return useDre1NamespaceImplementation(namespaceId.current);
}
