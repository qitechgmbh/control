...
export const UPDATE_LOAD_TOKEN_FILE = "update:load_token_file";
export const UPDATE_HAS_TOKEN = "update:has_token";
export const UPDATE_CLEAR_TOKEN = "update:clear_token";
