...

{
  ...
  boot.kernelParams = [
    ...
    "isolcpus=3" # Isolate cpus 2 and 3 from scheduler for better latency, 2 runs ethercatthread and 3 runs server control-loop
    ...
    "rcu_nocbs=3" # Moves RCU (Read-Copy Update) callback processing away from CPUs 2 and 3.
