...
#[derive(Debug)]
pub struct LinearJerkSpeedControllerDT {
    controller: JerkSpeedController,
}

impl LinearJerkSpeedControllerDT {
    ...
    pub fn update(&mut self, dt: Duration, target_speed: Velocity) -> Velocity {
        ...
        let speed_raw = self.controller.update(target_raw, dt.as_secs_f64());
