...
use qitech_lib::{
    ethercat_hal::{
        Consumer, MetaSubdevice, Producer, controller::{EtherCATAppHandle, EtherCATController}, devices::EthercatDevice
    },
...
pub fn write_ecat_inputs<C : Consumer,P: Producer>(
    ...
    //assert!(subdevices.subdevice_count == subdevices.len());
