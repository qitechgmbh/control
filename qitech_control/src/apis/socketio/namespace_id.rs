                ...
                E: de::Error,
            {
                ...
                if let Some(machine_path) = value.strip_prefix("/machine/") {
                    ...
                    if parts.len() == 3 {
                        ...
                        return Ok(NamespaceId::Machine(QiTechMachineIdentificationUnique {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        if let Some(machine_path) = s.strip_prefix("/machine/") {
            ...
            if parts.len() == 3 {
                ...
                return Ok(Self::Machine(QiTechMachineIdentificationUnique {
                    machine_identification: MachineIdentification { vendor, machine },
                    serial,
                }));
            }
...
mod tests {
    ...
    fn test_serialize_machine() {
        let machine_id = QiTechMachineIdentificationUnique {
    ...
    fn test_string_roundtrip() {
        ...
        let original = NamespaceId::Machine(QiTechMachineIdentificationUnique {
            machine_identification: MachineIdentification {
                vendor: 123,
                machine: 456,
            },
