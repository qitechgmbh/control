...
use crate::{
    ...
    aquapath1::{
        api::{
            ...
            LiveValuesEvent, ModeState, PidState, PidStates, StateEvent, TempState, TempStates,
        },
...
impl AquaPathV1 {
    const PID_MIN: f64 = 0.0;
    const PID_MAX: f64 = 5.0;
    const TOLERANCE_MIN_C: f64 = 0.0;
    const TOLERANCE_MAX_C: f64 = 10.0;
