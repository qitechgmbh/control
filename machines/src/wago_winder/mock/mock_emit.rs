...
use crate::wago_winder::Winder2Mode;
use crate::wago_winder::api::LiveValuesEvent;
use crate::wago_winder::api::{ModeState, SpoolAutomaticActionMode, StateEvent, Winder2Events};
use crate::wago_winder::puller_speed_controller::{GearRatio, PullerRegulationMode};
use crate::wago_winder::spool_speed_controller::SpoolSpeedControllerType;
use crate::{MACHINE_WAGO_WINDER_V1, VENDOR_QITECH};
...
impl WagoWinder {
    ...
    fn set_traverse_mode(&mut self, _mode: &Winder2Mode) {
        self.mode_state = ModeState {
            mode: crate::wago_winder::api::Mode::Standby,
            can_wind: true,
        };
        self.emit_state();
    }
