...
pub struct TraverseState {
    ...
    /// raw slot-2 input bit
    pub di1: bool,
    /// raw slot-2 reference input bit
    pub di2: bool,
    /// speed mode ack bit
    pub speed_mode_ack: bool,
    /// reference mode ack bit
    pub reference_mode_ack: bool,
    /// reference complete bit
    pub reference_ok: bool,
    /// reference run busy bit
    pub reference_busy: bool,
    /// raw 24-bit position from the 671
...
#[cfg(not(feature = "mock-machine"))]
impl MachineApi for WagoWinder {
    ...
    fn api_mutate(&mut self, request_body: Value) -> Result<(), anyhow::Error> {
        ...
        match mutation {
            ...
            Mutation::SetPullerTargetDiameter(_) => self.emit_state(),
