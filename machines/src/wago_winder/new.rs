...
impl MachineNewTrait for WagoWinder {
    fn new<'maindevice>(params: &MachineNewParams) -> Result<Self, Error> {
        ...
        smol::block_on(async {
            ...
            let spool_671 =
                get_slot_device::<Wago750_671>(&coupler, 1, "spool Wago 750-671").await?;
            let traverse_671 =
                get_slot_device::<Wago750_671>(&coupler, 2, "traverse Wago 750-671").await?;
            let puller_671 =
                get_slot_device::<Wago750_671>(&coupler, 3, "puller Wago 750-671").await?;
            ...
            let mut new = Self {
                ...
                spool: StepperVelocityWago750671::new(spool_671),
