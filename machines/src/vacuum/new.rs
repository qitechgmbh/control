use crate::vacuum::{Mode, VacuumMachine};
...
impl MachineNewTrait for VacuumMachine {
    fn new<'maindevice>(params: &MachineNewParams) -> Result<Self, Error> {
        ...
        {
            MachineNewHardware::Ethercat(x) => x, _ => {
                return Err(anyhow::anyhow!(
                    "[{}::VacuumMachine::new] MachineNewHardware is not Ethercat",
                    module_path!()
                ));
            }
        };
        ...
        block_on(async 
        {
            ...
            let mut machine = Self 
            {
                ...
                namespace: VacuumMachineNamespace 
                {
