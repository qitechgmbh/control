...
impl MachineNewTrait for TestMachine {
    fn new<'maindevice>(params: &MachineNewParams) -> Result<Self, Error> {
        ...
        block_on(async {
            ...
            let do1 = DigitalOutput::new(wago750_530.clone(), Wago750_530Port::DO1);
            let do2 = DigitalOutput::new(wago750_530.clone(), Wago750_530Port::DO2);
            let do3 = DigitalOutput::new(wago750_530.clone(), Wago750_530Port::DO3);
            let do4 = DigitalOutput::new(wago750_530.clone(), Wago750_530Port::DO4);
            drop(coupler);
            ...
            my_test.emit_state();
            println!("TestMachine::new called, Wago750_530 created!");
            Ok(my_test)
        })
    }
}
