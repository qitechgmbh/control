...
impl MachineNewTrait for Gluetex {
        ...
        Self: Sized,
    {
        ...
        let live_values = LiveValuesEvent {
            ...
            inlet_feeder_tension_arm_angle: 0.0,
            tape_feeder_tension_arm_angle: 0.0,
        ...
        let mut gluetex_mock_machine = Self {
            ...
            tape_feeder_tension_arm_state: TensionArmState::default(),
            winder_tension_arm_monitor_state: TensionArmMonitorState::default(),
            tape_feeder_tension_arm_monitor_state: TensionArmMonitorState::default(),
