...
use crate::gluetex::controllers::tension::{TensionArm, normalize_angle_deg};
...
impl SlavePullerSpeedController {
    ...
    fn speed_raw(&self, master_speed: Velocity, tension_arm: &TensionArm) -> Velocity {
        ...
        let current_angle = Angle::new::<units::angle::degree>(normalize_angle_deg(
            tension_arm.get_angle().get::<units::angle::degree>(),
        ))
        .abs();
