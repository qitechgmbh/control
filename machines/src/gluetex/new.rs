mod gluetex_imports {
    ...
    pub use super::super::controllers::line::ValveController;
    pub use super::super::controllers::line::{PullerSpeedController, SlavePullerSpeedController};
    pub use super::super::controllers::tension::TensionArm;
    pub use super::super::controllers::winding::{SpoolSpeedController, TraverseController};
...
use crate::gluetex::controllers::heating::TemperatureController;
    ...
    fn new<'maindevice>(params: &MachineNewParams) -> Result<Self, Error> {
        ...
        smol::block_on(async {
            ...
            let mut new = Self {
                ...
                stepper_3: StepperVelocityEL70x1::new(
                    el7031_addon3_shared.clone(),
                    EL7031_0030StepperPort::STM1,
                ),
                stepper_3_endstop: DigitalInput::new(
                    el7031_addon3_shared.clone(),
                    EL7031_0030DigitalInputPort::DI1,
                ),
                stepper_3_analog_input: AnalogInput::new(
                    el7031_addon3_shared,
                    EL7031_0030AnalogInputPort::AI1,
                ),
                stepper_4: StepperVelocityEL70x1::new(
                    el7031_addon4.clone(),
                    EL7031_0030StepperPort::STM1,
                ),
                stepper_5: StepperVelocityEL70x1::new(el7031_addon5, EL7031_0030StepperPort::STM1),
                tape_feeder_tension_arm: TensionArm::new(AnalogInput::new(
                    el7031_addon4.clone(),
                    EL7031_0030AnalogInputPort::AI1,
                )),
                optris_1: AnalogInput::new(
                ...
                stepper_3_controller: super::controllers::steppers::Stepper3Controller::new(200),
                stepper_4_controller: super::controllers::steppers::Stepper4Controller::new(200),
                stepper_5_controller: super::controllers::steppers::Stepper5Controller::new(200),
                stepper_5_tension_controller:
                    super::controllers::steppers::Stepper5TensionController::new(
                        Angle::new::<degree>(55.0),
                        Angle::new::<degree>(35.0),
                    ),
                stepper_3_last_sync: Instant::now(),
                winder_tension_arm: TensionArm::new(AnalogInput::new(
                    el7031_0030,
                    EL7031_0030AnalogInputPort::AI1,
                )),
