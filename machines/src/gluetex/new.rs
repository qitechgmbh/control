    ...
    fn new<'maindevice>(params: &MachineNewParams) -> Result<Self, Error> {
        ...
        smol::block_on(async {
            ...
            let mut new = Self {
                ...
                winder_tension_arm_monitor_config: super::TensionArmMonitorConfig::default(),
                winder_tension_arm_monitor_triggered: false,
                winder_tension_arm_out_of_range_since: None,
                addon_tension_arm_monitor_config: super::TensionArmMonitorConfig::default(),
                addon_tension_arm_monitor_triggered: false,
                addon_tension_arm_out_of_range_since: None,
                slave_tension_arm_monitor_config: super::TensionArmMonitorConfig::default(),
                slave_tension_arm_monitor_triggered: false,
                slave_tension_arm_out_of_range_since: None,
                optris_1_monitor_config: super::VoltageMonitorConfig::default(),
                optris_1_monitor_triggered: false,
                optris_1_out_of_range_since: None,
                optris_2_monitor_config: super::VoltageMonitorConfig::default(),
                optris_2_monitor_triggered: false,
                optris_2_out_of_range_since: None,
