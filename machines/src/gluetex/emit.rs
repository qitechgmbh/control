mod gluetex_imports {
    pub use super::super::controllers::line::PullerRegulationMode;
    pub use super::super::controllers::winding::SpoolSpeedControllerType;
...
use super::controllers::tension::normalize_angle_deg;
...
impl Gluetex {
    ...
    fn build_live_values_event(&mut self) -> LiveValuesEvent {
        let angle_deg = self.winder_tension_arm.get_angle().get::<degree>();

        // Wrap [270;<360] to [-90; 0] to reduce flicker around zero point
        let angle_deg = normalize_angle_deg(angle_deg);
        ...
        let live_values = LiveValuesEvent {
            ...
            temperature_1: self.heaters.zones[0].get_temperature().unwrap_or(0.0),
            temperature_2: self.heaters.zones[1].get_temperature().unwrap_or(0.0),
            temperature_3: self.heaters.zones[2].get_temperature().unwrap_or(0.0),
            temperature_4: self.heaters.zones[3].get_temperature().unwrap_or(0.0),
            temperature_5: self.heaters.zones[4].get_temperature().unwrap_or(0.0),
            temperature_6: self.heaters.zones[5].get_temperature().unwrap_or(0.0),
            heater_1_power: self.heaters.zones[0].get_heating_element_wattage(),
            heater_2_power: self.heaters.zones[1].get_heating_element_wattage(),
            heater_3_power: self.heaters.zones[2].get_heating_element_wattage(),
            heater_4_power: self.heaters.zones[3].get_heating_element_wattage(),
            heater_5_power: self.heaters.zones[4].get_heating_element_wattage(),
            heater_6_power: self.heaters.zones[5].get_heating_element_wattage(),
            slave_puller_speed: {
    ...
    pub fn build_state_event(&mut self) -> StateEvent {
        ...
        let state_event = StateEvent {
            ...
            tension_arm_state: super::state_from_domain::tension_arm_state_from_winder(
                &self.winder_tension_arm,
            ),
            ...
            heating_states: api::HeatingStates {
                enabled: self.heaters.enabled,
                zone_1: api::HeatingState {
                    target_temperature: self.heaters.zones[0]
                        .heating
                        .target_temperature
                        .get::<units::thermodynamic_temperature::degree_celsius>(),
                    wiring_error: self.heaters.zones[0].heating.wiring_error,
                    autotuning_active: self.heaters.zones[0].is_autotuning(),
                    autotuning_progress: self.heaters.zones[0].get_autotuning_progress(),
                },
                zone_2: api::HeatingState {
                    target_temperature: self.heaters.zones[1]
                        .heating
                        .target_temperature
                        .get::<units::thermodynamic_temperature::degree_celsius>(),
                    wiring_error: self.heaters.zones[1].heating.wiring_error,
                    autotuning_active: self.heaters.zones[1].is_autotuning(),
                    autotuning_progress: self.heaters.zones[1].get_autotuning_progress(),
                },
                zone_3: api::HeatingState {
                    target_temperature: self.heaters.zones[2]
                        .heating
                        .target_temperature
                        .get::<units::thermodynamic_temperature::degree_celsius>(),
                    wiring_error: self.heaters.zones[2].heating.wiring_error,
                    autotuning_active: self.heaters.zones[2].is_autotuning(),
                    autotuning_progress: self.heaters.zones[2].get_autotuning_progress(),
                },
                zone_4: api::HeatingState {
                    target_temperature: self.heaters.zones[3]
                        .heating
                        .target_temperature
                        .get::<units::thermodynamic_temperature::degree_celsius>(),
                    wiring_error: self.heaters.zones[3].heating.wiring_error,
                    autotuning_active: self.heaters.zones[3].is_autotuning(),
                    autotuning_progress: self.heaters.zones[3].get_autotuning_progress(),
                },
                zone_5: api::HeatingState {
                    target_temperature: self.heaters.zones[4]
                        .heating
                        .target_temperature
                        .get::<units::thermodynamic_temperature::degree_celsius>(),
                    wiring_error: self.heaters.zones[4].heating.wiring_error,
                    autotuning_active: self.heaters.zones[4].is_autotuning(),
                    autotuning_progress: self.heaters.zones[4].get_autotuning_progress(),
                },
                zone_6: api::HeatingState {
                    target_temperature: self.heaters.zones[5]
                        .heating
                        .target_temperature
                        .get::<units::thermodynamic_temperature::degree_celsius>(),
                    wiring_error: self.heaters.zones[5].heating.wiring_error,
                    autotuning_active: self.heaters.zones[5].is_autotuning(),
                    autotuning_progress: self.heaters.zones[5].get_autotuning_progress(),
                },
            },
            heating_pid_settings: api::HeatingPidStates {
                zone_1: api::HeatingPidSettings {
                    ki: self.heaters.zones[0].pid.get_ki(),
                    kp: self.heaters.zones[0].pid.get_kp(),
                    kd: self.heaters.zones[0].pid.get_kd(),
                    zone: String::from("zone_1"),
                },
                zone_2: api::HeatingPidSettings {
                    ki: self.heaters.zones[1].pid.get_ki(),
                    kp: self.heaters.zones[1].pid.get_kp(),
                    kd: self.heaters.zones[1].pid.get_kd(),
                    zone: String::from("zone_2"),
                },
                zone_3: api::HeatingPidSettings {
                    ki: self.heaters.zones[2].pid.get_ki(),
                    kp: self.heaters.zones[2].pid.get_kp(),
                    kd: self.heaters.zones[2].pid.get_kd(),
                    zone: String::from("zone_3"),
                },
                zone_4: api::HeatingPidSettings {
                    ki: self.heaters.zones[3].pid.get_ki(),
                    kp: self.heaters.zones[3].pid.get_kp(),
                    kd: self.heaters.zones[3].pid.get_kd(),
                    zone: String::from("zone_4"),
                },
                zone_5: api::HeatingPidSettings {
                    ki: self.heaters.zones[4].pid.get_ki(),
                    kp: self.heaters.zones[4].pid.get_kp(),
                    kd: self.heaters.zones[4].pid.get_kd(),
                    zone: String::from("zone_5"),
                },
                zone_6: api::HeatingPidSettings {
                    ki: self.heaters.zones[5].pid.get_ki(),
                    kp: self.heaters.zones[5].pid.get_kp(),
                    kd: self.heaters.zones[5].pid.get_kd(),
                    zone: String::from("zone_6"),
                },
            },
            connected_machine_state: cross_conn,
            addon_motor_3_state: api::AddonMotor5State {
                enabled: self.stepper_3_controller.is_enabled(),
                forward: self.stepper_3_controller.is_forward(),
                master_ratio: self.stepper_3_controller.get_master_ratio(),
                slave_ratio: self.stepper_3_controller.get_slave_ratio(),
                konturlaenge_mm: self.stepper_3_controller.get_konturlaenge_mm(),
                pause_mm: self.stepper_3_controller.get_pause_mm(),
                deceleration_distance_mm: self.stepper_3_controller.get_deceleration_distance_mm(),
                pattern_state: format!("{:?}", self.stepper_3_controller.get_pattern_state()),
            },
            addon_motor_4_state: api::AddonMotorState {
                enabled: self.stepper_4_controller.is_enabled(),
                forward: self.stepper_4_controller.is_forward(),
                master_ratio: self.stepper_4_controller.get_master_ratio(),
                slave_ratio: self.stepper_4_controller.get_slave_ratio(),
            },
            addon_motor_5_state: api::AddonMotorState {
                enabled: self.stepper_5_controller.is_enabled(),
                forward: self.stepper_5_controller.is_forward(),
                master_ratio: self.stepper_5_controller.get_master_ratio(),
                slave_ratio: self.stepper_5_controller.get_slave_ratio(),
            },
            addon_motor_5_tension_control_state: api::AddonMotorTensionControlState {
                enabled: self.stepper_5_tension_controller.is_enabled(),
                target_angle: self
                    .stepper_5_tension_controller
                    .get_target_angle()
                    .get::<degree>(),
                sensitivity: self
                    .stepper_5_tension_controller
                    .get_sensitivity()
                    .get::<degree>(),
                min_speed_factor: self.stepper_5_tension_controller.get_min_speed_factor(),
                max_speed_factor: self.stepper_5_tension_controller.get_max_speed_factor(),
            },
    ...
    pub fn puller_set_gear_ratio(&mut self, gear_ratio: super::controllers::line::GearRatio) {
    ...
    pub fn set_target_temperature(&mut self, target_temperature: f64, zone: api::HeatingZone) {
        ...
        match zone {
            api::HeatingZone::Zone1 => self.heaters.zones[0].set_target_temperature(target_temp),
            api::HeatingZone::Zone2 => self.heaters.zones[1].set_target_temperature(target_temp),
            api::HeatingZone::Zone3 => self.heaters.zones[2].set_target_temperature(target_temp),
            api::HeatingZone::Zone4 => self.heaters.zones[3].set_target_temperature(target_temp),
            api::HeatingZone::Zone5 => self.heaters.zones[4].set_target_temperature(target_temp),
            api::HeatingZone::Zone6 => self.heaters.zones[5].set_target_temperature(target_temp),
        }
        self.emit_state();
    }
    ...
    pub fn set_heating_enabled(&mut self, enabled: bool) {
        self.heaters.enabled = enabled;
        if enabled {
            self.heaters.allow_all_heating();
        } else {
    ...
    pub fn configure_heating_pid(&mut self, settings: api::HeatingPidSettings) {
        match settings.zone.as_str() {
            "zone_1" => {
                self.heaters.zones[0]
                    .pid
                    .configure(settings.ki, settings.kp, settings.kd);
            }
            "zone_2" => {
                self.heaters.zones[1]
                    .pid
                    .configure(settings.ki, settings.kp, settings.kd);
            }
            "zone_3" => {
                self.heaters.zones[2]
                    .pid
                    .configure(settings.ki, settings.kp, settings.kd);
            }
            "zone_4" => {
                self.heaters.zones[3]
                    .pid
                    .configure(settings.ki, settings.kp, settings.kd);
            }
            "zone_5" => {
                self.heaters.zones[4]
                    .pid
                    .configure(settings.ki, settings.kp, settings.kd);
            }
            "zone_6" => {
                self.heaters.zones[5]
                    .pid
                    .configure(settings.ki, settings.kp, settings.kd);
            }
    ...
    pub fn start_heating_autotune(&mut self, zone: api::HeatingZone, target_temp: f64) {
        ...
        match zone {
            api::HeatingZone::Zone1 => {
                self.heaters.zones[0].start_autotuning(target);
                tracing::info!(
            ...
            api::HeatingZone::Zone2 => {
                self.heaters.zones[1].start_autotuning(target);
                tracing::info!(
            ...
            api::HeatingZone::Zone3 => {
                self.heaters.zones[2].start_autotuning(target);
                tracing::info!(
            ...
            api::HeatingZone::Zone4 => {
                self.heaters.zones[3].start_autotuning(target);
                tracing::info!(
            ...
            api::HeatingZone::Zone5 => {
                self.heaters.zones[4].start_autotuning(target);
                tracing::info!(
            ...
            api::HeatingZone::Zone6 => {
                self.heaters.zones[5].start_autotuning(target);
                tracing::info!(
    ...
    pub fn stop_heating_autotune(&mut self, zone: api::HeatingZone) {
        match zone {
            api::HeatingZone::Zone1 => {
                self.heaters.zones[0].stop_autotuning();
                tracing::info!("Stopped auto-tuning for zone 1");
            }
            api::HeatingZone::Zone2 => {
                self.heaters.zones[1].stop_autotuning();
                tracing::info!("Stopped auto-tuning for zone 2");
            }
            api::HeatingZone::Zone3 => {
                self.heaters.zones[2].stop_autotuning();
                tracing::info!("Stopped auto-tuning for zone 3");
            }
            api::HeatingZone::Zone4 => {
                self.heaters.zones[3].stop_autotuning();
                tracing::info!("Stopped auto-tuning for zone 4");
            }
            api::HeatingZone::Zone5 => {
                self.heaters.zones[4].stop_autotuning();
                tracing::info!("Stopped auto-tuning for zone 5");
            }
            api::HeatingZone::Zone6 => {
                self.heaters.zones[5].stop_autotuning();
    ...
    pub fn check_autotuning_results(&mut self) {
        ...
        if let Some((kp, ki, kd)) = self.heaters.zones[0].get_autotuning_result() {
            tracing::info!(
        ...
        if let Some((kp, ki, kd)) = self.heaters.zones[1].get_autotuning_result() {
            tracing::info!(
        ...
        if let Some((kp, ki, kd)) = self.heaters.zones[2].get_autotuning_result() {
            tracing::info!(
        ...
        if let Some((kp, ki, kd)) = self.heaters.zones[3].get_autotuning_result() {
            tracing::info!(
        ...
        if let Some((kp, ki, kd)) = self.heaters.zones[4].get_autotuning_result() {
            tracing::info!(
        ...
        if let Some((kp, ki, kd)) = self.heaters.zones[5].get_autotuning_result() {
            tracing::info!(
...
#[cfg(test)]
mod tests {
    use super::{estimate_spool_minutes_remaining, normalize_angle_deg};
    use units::f64::{Length, Velocity};
    use units::length::meter;
    use units::velocity::meter_per_minute;

    #[test]
    fn normalize_angle_deg_keeps_low_angles_unchanged() {
    ...
    #[test]
    fn normalize_angle_deg_wraps_upper_quadrant() {
