...
```typescript
import { MyMachinePage } from "@ui/machines/minimal_machines/MyNewMachine/MyMachinePage";
import { MyMachineControlPage } from "@ui/machines/minimal_machines/MyNewMachine/MyMachineControlPage";
```
